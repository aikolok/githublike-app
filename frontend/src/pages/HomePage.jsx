...
const HomePage = () => {
  ...
  const getUserProfileAndRepos = useCallback(async (username = "aikolok") => {
    setLoading(true);
    try {
  ...
  const onSort = (sortType) => {
    if (sortType === "recent") {
      repos.sort((a, b) => new Date(b.created_at) - new Date(a.created_at)); // descending order: recent repos first
